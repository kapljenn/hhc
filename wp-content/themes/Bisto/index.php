...
<html class="custom">
    <head>
        ...
        <!-- Page title -->
        <title>Bisto Together Project</title>
    ...
    <body class="slides cards fast whiteSlide animated">
  ...
  <div class="sections">
    <div class="right">
        <span class="share-icons">
            <a class="icon social-icon" href="https://www.facebook.com/AahBisto" target="_blank"><i class="icon-facebook"></i></a>
            <a class="icon social-icon" href="https://www.youtube.com/user/bistotogetherproject" target="_blank"><i class="icon-youtube"></i></a>
        </span>
    </div>
  </div>
</nav>
...
$the_query_start = new WP_Query( $args_start );
while ( $the_query_start->have_posts() ) : $the_query_start->the_post();
$pid = get_the_ID();
?>
...
<section class="slide fade kenBurns">
    <nav class="panel top">
      <div class="sections">
        <div class="left"><a href="#">
            <img class="bisto-logo" src="<?php the_field('logo'); ?>" alt="Bisto" width="180" height="131">
            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#logo"></use></a>
        </div>
      </div>
    </nav>
    <div class="content">
    <div class="container">
        <div class="wrap">
            <div class="fix-11-12">
                <h1 class="ae-1"><?php echo get_the_content(); ?></h1>
            </div>
            <div class="fix-11-12 hide-for-small">
                <?php
                $args = array(
                	'post_type' => 'post',
                    'order' => 'ASC',
                ...
                ?>
                    <a href="#<?php the_title(); ?>" class="button square stroke ae-3 home-button"><?php the_title(); ?></a>
                <?php endwhile; ?>
            </div>

            <div class="mobile-menu-opener">
                <a href="#" class="button square stroke ae-3 home-button">See all Projects</a>
            </div>

        </div>
    </div>
  </div>
    <div class="background" style="background-image:url(<?php the_field('background_image', $pid); ?>)"></div>
    <nav class="panel bottom">
        <div class="sections">
            <div class="center">
                <span class="nextSlide">
                    <a class="fontelloicon" href="#arrow-down">
                        <span class="discover-more"><?php the_field('button_text', $pid); ?></span>
                        <span class="discover-arrow-down"><i class="fontelloicon-circle-down"></i></span>
                    </a>
                </span>
            </div>
        </div>
...
<!-- Slide #2 -->
<section class="slide fade kenBurns" name="<?php the_title(); ?>">
    <div class="content">
        <div class="container">
            <div class="wrap">
                <?php if (get_field('logo')!="") { ?>
                <div class="fix-11-12">
                    <img class="optional-logo" src="<?php the_field('logo'); ?>" alt="logo" width="300">
                </div>
                <?php } ?>
                <div class="fix-11-12">
                    <h1 class="ae-1"><?php echo get_the_content(); ?></h1>
                </div>
                <div class="button play white small popupTrigger toCenter ae-6 fromCenter block play-21" data-popup-id="<?php the_ID(); ?>">
  ...
  <!-- </div> -->
    <div class="background" style="background-image:url(<?php the_field('background_image'); ?>)"></div>
    <nav class="panel bottom">
        <div class="sections">
            <div class="center">
                <span class="nextSlide">
...
<!-- Popup Video -->
<div class="popup autoplay" data-popup-id="<?php the_ID(); ?>">
            ...
            <div class="wrap">
                <div class="fix-10-12">
                    <div class="embedVideo popupContent">
                        <iframe src="<?php the_field('video_url'); ?>" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
...
$the_query_end = new WP_Query( $args_end );
while ( $the_query_end->have_posts() ) : $the_query_end->the_post();
$pid = get_the_ID();
?>
...
<div class="fix-11-12 mobile-menu-container">
    ...
    while ( $the_query->have_posts() ) : $the_query->the_post();
    ?>
        <a href="#<?php the_title(); ?>" class="close-mobile-menu-links button square stroke home-button"><?php the_title(); ?></a>
    <?php endwhile; ?>
