...
<html class="custom">
    <head>
        ...
        <!-- Page title -->
        <title>Home and Homes for Children</title>
        ...
        <!-- Styles -->
        <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/slides.css" name="main-styles">
        <!-- Custom Styles -->
        <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/custom.css" name="custom-styles">
        <!-- Scripts -->
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"></script>
        <script src="<?php bloginfo('template_url'); ?>/js/plugins.js" type="text/javascript" name="plugins"></script>
        <script src="<?php bloginfo('template_url'); ?>/js/slides.js" type="text/javascript" name="main-scripts"></script>
        <script src="<?php bloginfo('template_url'); ?>/js/script.js" type="text/javascript" name="custom-scripts"></script>
                
                
                 
    </head>
    <body class="slides film whiteSlide animated">
...
<nav class="panel top forceMobileView">
  <div class="sections desktop">
    <div class="left">
    <a href="#" class="logo">
    <img alt="Hope and Homes for Children logo" src="<?php bloginfo('template_url'); ?>/assets/img/hope-and-homes-for-children-logo.png">
    </a>
    </div>
    <div class="center">
				...
				<div class="fix-12-12">
					...
					<ul class="grid grid-50">
						<li class="col-4-12 left ae-3">
							<h3 class="uppercase ae-4">Meet Quick</h3>
							<div class="ae-5"><p class="small">Design is so critical it should be on the agenda of every meeting.</p></div>
						</li>
						<li class="col-4-12 left ae-4">
							<h3 class="uppercase ae-5">Nice Experience</h3>
							<div class="ae-6"><p class="small">Space and light and order. Those are the things that men.</p></div>
						</li>
						<li class="col-4-12 left ae-5">
							<h3 class="uppercase ae-6">Simple Beauty</h3>
							<div class="ae-7"><p class="small">Space and light and order. Those are the things that men.</p></div>
						</li>
					</ul>
				</div>
        ...
        <div class="fix-12-12">
          <ul class="grid">
            <li class="col-6-12 left ae-1 image-61" data-action="zoom">
              <img class="shiftImage shiftImageVertical macbook-61" src="assets/img/macbook-1.png" width="1200" alt="iPad Image"/>
            </li>
            <li class="col-6-12 left">
              <h1 class="small ae-2">I am creator</h1>
              <div class="ae-3">
                <p>Scene Generator allows you to create your own unique scenes just by dragging and dropping items into a special&nbsp;scene.</p>
              </div>
              <ul class="grid equal later">
                <li class="col-6-12 ae-4 equalElement">
                  <svg width="44" height="34" viewBox="0 0 90 72" class="icon-61" xmlns="http://www.w3.org/2000/svg"><g stroke-width="4" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M1.553 28.514l10.683 15.908 12.286-14.712"/><path d="M88.083 45l-10.68-15.908-12.29 14.708"/><path d="M77.381 29.15c2.959 17.304-8.832 33.542-25.07 37.375-11.324 2.68-22.678-.916-30.402-8.529"/><path d="M12.195 44.229c-4.474-18.726 7.609-36.984 25.124-41.124 12.098-2.864 24.215 1.43 31.913 10.124"/><path d="M50.237 40.261c-2.99 2.99-7.847 2.99-10.837 0-2.994-2.994-2.994-7.847 0-10.844 2.99-2.986 7.847-2.986 10.837 0 2.994 2.998 2.994 7.851 0 10.844z"/></g></svg>
                  <h3 class="uppercase">Mockup</h3>
                  <p class="small">Select premade adjustment layers with ease.</p>
                </li>
                <li class="col-6-12 ae-5 equalElement">
                  <svg width="34" height="34" viewBox="0 0 72 72" class="icon-61" xmlns="http://www.w3.org/2000/svg"><g stroke-width="4" stroke-linejoin="round" fill="none"><path d="M1 28.313c23.023 0 41.688 18.664 41.688 41.688"></path><path d="M1 2.438c37.312 0 67.563 30.251 67.563 67.563"></path><path d="M16.813 61.375c0 3.97-3.217 7.188-7.188 7.188-3.97 0-7.188-3.217-7.188-7.188 0-3.97 3.217-7.188 7.188-7.188 3.97 0 7.188 3.217 7.188 7.188z"></path></g></svg>
                  <h3 class="uppercase">Layers</h3>
                  <p class="small">Open a smart object, paste your design and save.</p>
                </li>
                <li class="col-6-12 ae-6 equalElement">
                  <svg width="26" height="34" viewBox="0 0 59 72" class="icon-61" xmlns="http://www.w3.org/2000/svg"><g stroke-width="4" stroke-linejoin="round" fill="none"><path d="M20 62c0 4.5-4.029 9-9 9-4.968 0-9-4.029-9-9 0-4.968 4.032-9 9-9h9v9z"></path><path d="M54 50c0 4.5-4.029 9-9 9-4.968 0-9-4.029-9-9 0-4.968 4.032-9 9-9h9v9z"></path><path d="M20 56v-40.114l34-13.886v44.743"></path><path d="M20 26l34-14"></path></g></svg>
                  <h3 class="uppercase">Branding</h3>
                  <p class="small">Just select a background, drop items that you like and finalize a scene.</p>
                </li>
                <li class="col-6-12 ae-7 equalElement">
                  <svg width="34" height="34" viewBox="0 0 72 72" class="icon-61" xmlns="http://www.w3.org/2000/svg"><g stroke-width="4" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M48.782 69.444h-26.565c0-7.338 5.948-17.71 13.282-17.71 7.335 0 13.282 10.372 13.282 17.71zM44.355 36.976c0 4.888-3.967 8.855-8.855 8.855s-8.855-3.967-8.855-8.855c0-4.891 3.967-8.855 8.855-8.855s8.855 3.964 8.855 8.855zM19.848 51.152c-8.648-8.648-8.648-22.663 0-31.308 8.642-8.642 22.66-8.642 31.302 0 8.648 8.645 8.648 22.66 0 31.308M11.498 59.5c-13.256-13.253-13.256-34.744 0-48.006 13.256-13.253 34.747-13.253 48.006 0 13.256 13.262 13.256 34.753 0 48.006"></path></g></svg>
                  <h3 class="uppercase">Present</h3>
                  <p class="small">Create unique items by pasting your design, text, logo or illustration.</p>
                </li>
  ...
  <div class="content">
    <div class="container">
      <div class="wrap">
        ...
        <div class="fix-10-12 toCenter">
          <h1 class="ae-1">Heart of the image</h1>
          <div class="ae-2"><p class="hero">It&rsquo;s quicker to hate on a design picking out all the little things that should have done than to just do something great&nbsp;yourself.</p></div>
        </div>
        <div class="fix-12-12">
          <ul class="grid later equal">
            <li class="col-4-12">
              <div class="fix-4-12">
                <svg width="90" height="72" viewBox="0 0 90 72" class="ae-3 fromCenter icon-48" xmlns="http://www.w3.org/2000/svg"><g stroke-width="3" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M1.553 28.514l10.683 15.908 12.286-14.712"/><path d="M88.083 45l-10.68-15.908-12.29 14.708"/><path d="M77.381 29.15c2.959 17.304-8.832 33.542-25.07 37.375-11.324 2.68-22.678-.916-30.402-8.529"/><path d="M12.195 44.229c-4.474-18.726 7.609-36.984 25.124-41.124 12.098-2.864 24.215 1.43 31.913 10.124"/><path d="M50.237 40.261c-2.99 2.99-7.847 2.99-10.837 0-2.994-2.994-2.994-7.847 0-10.844 2.99-2.986 7.847-2.986 10.837 0 2.994 2.998 2.994 7.851 0 10.844z"/></g></svg>
            ...
            <li class="col-4-12">
              <div class="fix-4-12">
                <svg width="72" height="72" viewBox="0 0 72 72" class="ae-4 fromCenter icon-48" xmlns="http://www.w3.org/2000/svg"><g stroke-width="3" stroke-linejoin="round" fill="none"><path d="M1 28.313c23.023 0 41.688 18.664 41.688 41.688"/><path d="M1 2.438c37.312 0 67.563 30.251 67.563 67.563"/><path d="M16.813 61.375c0 3.97-3.217 7.188-7.188 7.188-3.97 0-7.188-3.217-7.188-7.188 0-3.97 3.217-7.188 7.188-7.188 3.97 0 7.188 3.217 7.188 7.188z"/></g></svg>
            ...
            <li class="col-4-12">
              <div class="fix-4-12">  
                <svg class="ae-5 fromCenter icon-48" width="56" height="72" viewBox="0 0 56 73" xmlns="http://www.w3.org/2000/svg" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns"><g stroke-width="3" stroke-linejoin="round" fill="none"><path d="M20 62c0 4.5-4.029 9-9 9-4.968 0-9-4.029-9-9 0-4.968 4.032-9 9-9h9v9z"/><path d="M54 50c0 4.5-4.029 9-9 9-4.968 0-9-4.029-9-9 0-4.968 4.032-9 9-9h9v9z"/><path d="M20 56v-40.114l34-13.886v44.743"/><path d="M20 26l34-14"/></g></svg>
  ...
  <div class="content">
    <div class="container">
      <div class="wrap">
        ...
        <div class="fix-10-12">
          <h1 class="small ae-1">It&rsquo;s very easy to be different, but very difficult to be better.</h1>
          <div class="ae-2">
            <p>He takes snapshots, makes notes and records impressions on tablecloths or newspapers, on backs of envelopes or matchbooks. Why one thing and not another is part of the mystery, but he is&nbsp;omnivorous.</p>
          </div>
          <a class="button round uppercase pink ae-5 fromCenter">Start Free Trial</a>
        </div>
  ...
  <div class="content">
    <div class="container">
      <div class="wrap">
        ...
        <div class="fix-10-12 toCenter">
          <h2 class="micro ae-1">Case Study</h2>
          <h1 class="small ae-1">Create your own visual style</h1>
          <div class="ae-2"><p>However, I’ve always been more concerned with users. Programmers do their work but once, while users are saddled with it ever thereafter.</p></div>
        </div>
        <div class="fix-12-12">  
          <ul class="grid later equal left">
            <li class="col-3-12">
              <div class="button empty videoThumbnail noShadow popupTrigger ae-3" data-popup-id="91-4"><img class="img-91 rounded wide" src="assets/img/img-91-1.jpg" alt="Video Thumbnail"/></div>
              <h3 class="uppercase equalElement ae-4 text-91">Inspiration</h3>
              <div class="ae-5"><p class="small">We live in a society where everybody feels guilty.</p></div>
            </li>
            <li class="col-3-12">
              <a href="#" class="button empty ae-4"><img class="img-91 rounded wide" src="assets/img/img-91-2.jpg" alt="Image Thumbnail"/></a>
              <h3 class="uppercase equalElement ae-5 text-91">Creativity</h3>
              <div class="ae-6"><p class="small">You don’t have to be “a creative” to be creative.</p></div>
            </li>
            <li class="col-3-12">
              <a href="#" class="button empty ae-5"><img class="img-91 rounded wide" src="assets/img/img-91-3.jpg" alt="Image Thumbnail"/></a>
              <h3 class="uppercase equalElement ae-6 text-91">Fashion</h3>
              <div class="ae-7"><p class="small">There is no such thing as simple. Simple is hard.</p></div>
            </li>
            <li class="col-3-12">
              <a href="#" class="button empty ae-6"><img class="img-91 rounded wide" src="assets/img/img-91-4.jpg" alt="Image Thumbnail"/></a>
              <h3 class="uppercase equalElement ae-7 text-91">Photography</h3>
              <div class="ae-8"><p class="small">Design makes what was once impossible possible.</p></div>
            </li>
          </ul>
        </div>
  ...
  <div class="content">
    <div class="container">
      <div class="wrap">
        ...
        <h1 class="small ae-1">Ready to Purchase?</h1>
        <div class="ae-2"><p>Without deviation from the norm progress is not&nbsp;possible.</p></div>
        <div class="fix-10-12 box-51">
          <ul class="grid later equal">
            <li class="col-6-12 cell-51">
              <div class="fix-5-12 crop">
                <div class="pad shadow ae-3 pad-51">
                  <img src="assets/img/app-3-26.png" class="ae-4 app-51" alt="App 1"/>
                  <h3 class="uppercase ae-5">Origami</h3>
                  <div class="ae-6"><p class="small equalElement">Space and light and order. Those are the things that men.</p></div>
                  <div class="button pink round uppercase wide button-51 ae-7">Purchase</div>
                </div>
              </div>
            </li>
            <li class="col-6-12">
              <div class="fix-5-12 crop">
                <div class="pad shadow ae-4 pad-51">
                  <img src="assets/img/app-2-26.png" class="ae-5 app-51" alt="App 2"/>
                  <h3 class="uppercase ae-6">Framer</h3>
                  <div class="ae-7"><p class="small equalElement">Design is not making beauty, beauty emerges from selection.</p></div>
                  <div class="button pink round uppercase wide button-51 ae-8">Purchase</div>
                </div>
              </div>
            </li>
          </ul>
  ...
  <div class="content">
    <div class="container">
      <div class="wrap">
        ...
        <div class="fix-10-12">
          <h1 class="small ae-1">Start free trial</h1>
          <form action="#" autocomplete="off" class="form-96">
            <input type="email" class="ae-2 fromLeft input-96" name="email" placeholder="Email"/>
            <input type="submit" class="button pink uppercase ae-3 fromRight" name="name" placeholder="Name" value="Get Updates"/>
          </form>
          <div class="ae-4"><p class="small">No risk trial &nbsp;&bull;&nbsp; Support &nbsp;&bull;&nbsp; Frequent updates</p></div>
        </div>
                
      </div>
    </div>
  </div>
  <div class="background" style="background-image:url(assets/img/img-96.jpg)"></div>
</section>
